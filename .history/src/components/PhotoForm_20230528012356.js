    ...
    <div className={classes.container}>
      ...
      {isFormOpen && (
        <div className={classes.form}>
          ...
          <Input placeholder="Title" variant="width100" value={imageTitle}  onChange={(event)=>{
            setImageTitle(event.tar)
          }}/>
          <Input placeholder="Image URL" variant="width100" value={imageUrl} />
